    ...
    <section className="hero" id="about">
      ...
      <div className="hero-terminal">
        ...
        <div className="hero-terminal__body">
          ...
          <p className="hero-terminal__indent">
          ...
          <p className="hero-terminal__indent hero-terminal__indent--double">
            createApplications();
          </p>
          ...
          <p className="hero-terminal__indent">{"}"}</p>
